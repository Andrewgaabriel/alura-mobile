...
export default function Resumo() {
    ...
    const { mensagemCompra, topoCompra, tituloCompra, botaoHomeCompra, botaoProdutorCompra} = useTextos();
    ...
    return <View style={estilos.tela}>
        ...
        <View style={estilos.conteudo}>
            ...
            <View style={estilos.textos}>
                ...
                <TouchableOpacity style={estilos.botao} onPress={() => { navigation.popToTop() }}>
                    <Text style={estilos.textoBotao}>{botaoHomeCompra}</Text>
                </TouchableOpacity>

                <TouchableOpacity style={[estilos.botao, estilos.botaoProdutor]} onPress={() => { navigation.pop(2) }}>
